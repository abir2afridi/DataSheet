...
import { Lock, Unlock, Search, Terminal, Radio, Shield, HelpCircle, Eye, Sun, Moon } from "lucide-react";
...
export default function Header({
  ...
  return (
    <header className="h-14 bg-[#050806] border-b border-emerald-500/30 flex items-center justify-between px-4 font-mono text-emerald-400 z-10 shrink-0 select-none">
      {/* Brand area */}
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Global UNLOCK MODE toggle. Clicking this allows unlocking cell directly with confirm workflow */}
        <button
